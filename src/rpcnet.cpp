...
Value addnode(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n"
            "> pos-cli addnode \"192.168.0.6:21033\" \"onetry\"\n"
            "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", \"method\": \"addnode\", \"params\": [\"192.168.0.6:21033\", \"onetry\"] }' -H 'content-type: text/plain;' http://127.0.0.1:21034/\n");
